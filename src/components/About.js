            ...
            <div className="md:absolute md:flex bg-white w-full ">
                <div className="flex flex-col items-center">
                    ...
                    <div className="pt-4 mt-8 font-dosis md:text-lg">
                        ...
                        <p className="md:flex items-center text-center"> <img src="./Picto_noirs/picto_diplome.jpg" alt="Pictogramme diplôme" className="w-14 ml-12 md:ml-0 md:mr-2"/>BTS de communication</p>
